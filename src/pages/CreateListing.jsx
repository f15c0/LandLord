...
const onChange =(e)=>{
    ...
    const [formData, setFormData] = useState({
        ...
        description:'', offer:false, price:0, discount:0
    })
                ...
                <form className="pb-4 mx-4">
                    ...
                    <div className="flex justify-between"> 
                        <div className="pt-2 mt-2 font-semibold">
                            ...
                            <p className={formLabel}><span>car</span> Parking Lot / Spot</p>
                        ...
                        <div className="pt-2 mt-2 font-semibold">
                            ...
                            <span className="ml-3 sm:text-sm text-xs font-medium text-gray-900 dark:text-gray-300 uppercase">
                                ...
                                {/* Address Form Field  */}
                        <div>
                        <p className={`py-2 mt-1 ${formLabel}`}>Address</p>
                        <div className="">
                            <textarea type="text" 
                                id="address" 
                    ...
                    <div className="pt-2 mt-1 font-semibold">
                        ...
                        <div className="flex justify-between space-x-4">
                            <div className="w-[50%] flex justify-center items-center space-x-2">
                             ...
                             <div className="w-[35%]">
                                <p className={formLabel}>Discount Price:</p>
                                    <input type="number" 
                                        id="discount"
