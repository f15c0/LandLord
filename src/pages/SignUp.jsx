...
const  handleSubmit= async (e)=>{
    ...
    return (
        <section>
           ...
           <div className="flex justify-center flex-wrap items-center px-6 py-2 mx-auto max-w-7xl">
                ...
                <div className="w-full md:w-[70%] lg:w-[50%] ">
                    ...
                    <input type="text" 
                            ...
                            className="w-full form-input px-4 py-3 text-xs sm:text-sm rounded-lg mb-4"
                            required
                            name="name"
                            value={formData.name}
                        ...
                        <input type="email" 
                            placeholder="Email" 
                            className="w-full form-input px-4 py-3 text-xs sm:text-sm rounded-lg"
                            required
                            name="email"
                            ...
                            className="w-full form-input mt-4 px-4 py-3 text-xs sm:text-sm rounded-md"
                            required
                            name="password"
                       ...
                       <div className="flex justify-between mt-2">
                            <p> <span className="font-normal text-sm sm:text-base">Have an account? </span>{' '} 
                                <Link to='/sign-in' className="text-red-700 text-sm sm:text-base">Log in</Link>
                            </p>
                        ...
                        <button type="submit" className="text-sm sm:text-base text-center mt-5 px-6 rounded-lg transition ease-in-out py-2 border-none bg-blue-700 text-white hover:bg-blue-400 w-full uppercase shadow-sm hover:shadow-md active:bg-blue-800 shadow-gray-500">Sign Up</button>
